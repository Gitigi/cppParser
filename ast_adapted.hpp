...
BOOST_FUSION_ADAPT_STRUCT(cpp::ast::lambda,param,body)
...
BOOST_FUSION_ADAPT_STRUCT(cpp::ast::function_declarator,spec,type,name,exception_spec)
BOOST_FUSION_ADAPT_STRUCT(cpp::ast::decl_func,name,param)
BOOST_FUSION_ADAPT_STRUCT(cpp::ast::decl_func_ptr,pointers,decl)
BOOST_FUSION_ADAPT_STRUCT(cpp::ast::decl_func_lref,decl)
BOOST_FUSION_ADAPT_STRUCT(cpp::ast::decl_func_rref,decl)
...
BOOST_FUSION_ADAPT_STRUCT(cpp::ast::derived_class,specifier,classname)
...
BOOST_FUSION_ADAPT_STRUCT(cpp::ast::class_decl,type,name,bases,var)
